                          ...
                          DropdownMenuItem<String>(
                            child: RichText(
                              text: TextSpan(
                                text: 'gained',
                                style:
                                    TextStyle(color: maintGreen, fontSize: 30),
                              ),
                            ),
                            value: "gained",
                          ),
                  ...
                  onPressed: () {
                    switch (_type) {
                      ...
                      case "gained":
                        ...
                        break;
                      case "transfered":
                        createTransfer(double.parse(priceController.text),
                            nameController.text, widget.purseId!,int.parse(purseIdController.text));
                        break;
                      default:
                        break;
                    }
